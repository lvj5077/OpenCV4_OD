...
int main( int argc, char **argv)
{
    ...
    // Read Darknet
    const std::string model   = "../yolov4-tiny.weights";
    const std::string config  = "../yolov4-tiny.cfg";
    ...
    */
    ...
    // while( true )
    {
        ...
        for( const int32_t& index : indices ){
            ...
            cout << "class: "<<classes[class_ids[index]]  <<" | rrectangle " << rectangle << endl;
        ...
        // Show Image
        cv::imshow( "Object Detection YOLO", frame );

        cv::imwrite("/Users/jin/Desktop/test01yolo4.png",frame);
